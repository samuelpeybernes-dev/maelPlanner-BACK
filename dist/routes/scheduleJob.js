...
const scheduleJob = __importStar(require("../controllers/scheduleJob"));
...
router.route('/postSchedule').post(validateIncomingData_js_1.default, scheduleJob.apiPostScheduleJob);
